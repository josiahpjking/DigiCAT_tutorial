...
We are continuing to develop DigiCAT to make more approaches available.  Please see X for a list of features that are currently under development. Feel free to get in touch [uoe_digicat-group@uoe.onmicrosoft.com](mailto:uoe_digicat-group@uoe.onmicrosoft.com) if you have suggestions for approaches you would like to see within the tool.
